...
define('DOMAIN_URL', 'https://gandhimarket.graymatterworks.com/'); /* chnage to your domain here - don't forget to add forward slash at the end of the URL like this "/" */
...
class Database
{
    ...
    private $db_user = "u743445510_giffy";  // Change as required
    private $db_pass = "Giffy@2024";  // Change as required
    private $db_name = "u743445510_giffy";    // Change as required
